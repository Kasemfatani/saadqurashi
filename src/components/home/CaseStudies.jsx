...
export default function CaseStudies() {
    ...
    return (
        <>
            {
                loading ? <Loading /> :
                    <div className="case-studies" id='case_studies' style={{ direction: lang === 'ar' ? 'rtl' : 'ltr' }}>
                        <div className="container m-auto">
                            <h2>{lang === 'en' ? 'Driving Digital Transformation for Leading Industries' : 'تحقيق التحول الرقمي للمصانع الرائدة'}</h2>
                            <h3>{lang === 'en' ? parse(`At i-Masira, we deliver real, measurable impact. <br /> Explore how our smart solutions have transformed factories across Saudi Arabia.`) : 'في i-Masira  نقدم تأثيرا ملموسا من خلال حلول صناعية ذكية اكتشف كيف ساعدنا المصانع في المملكة العربية السعودية على تحقيق التحول الرقمي بكفاءة'}</h3>
                            <Swiper
                                navigation
