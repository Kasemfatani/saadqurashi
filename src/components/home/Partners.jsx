        ...
        <>
            {
                loading ? <Loading /> :
                    <>
                        ...
                        <Marq mainTitle={lang === 'en' ? 'Our clients' : 'عملاؤنا'} subTitle={lang === 'en' ? 'Trusted by top manufacturers for smart industrial solutions' : 'موثوق بنا من قبل أكبر المصانع لحلول صناعية ذكية.'} data={data.clients} isReverse={false} />
                    </>
            }
        </>
    )
